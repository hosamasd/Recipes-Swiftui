...
var recipes = [
    ...
    Recipe(image: "r1", title: "Mexican Egg dex", detail: "A gentle combination of carefully chosen veggies with a Mexican taste.", rating: "4.5", type: "easy",color: Color("blue")),
    Recipe(image: "r2", title: "Italian Baked fish", detail: "Italian based spicy and green beans baked together with cheeze", rating: "4.8", type: "hard",color: Color("yellow")),
]
